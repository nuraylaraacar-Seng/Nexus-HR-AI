...
const ms = {
  ...
  body:      { overflowY: 'auto', overflowX: 'visible', padding: '0 24px 32px', display: 'flex', flexDirection: 'column', gap: 7 },
  select:    { flex: 1, padding: '7px 10px', borderRadius: 8, border: '1px solid #cbd5e1', fontSize: 13, background: '#fff', outline: 'none', cursor: 'pointer', appearance: 'auto', WebkitAppearance: 'auto' },
